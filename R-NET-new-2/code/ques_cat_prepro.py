        ...
        for article in tqdm(source["data"]):
            for para in article["paragraphs"]:
                ...
                for qa in para["qas"]:
                    ...
                    # add the tokens at the end of the question (worf and character)
                    ###################################################################
                    ...
                    # add the question category at the end of the question
                    ques_tokens.append(ques_category_token[0])
                    
                    ques_category_chars = list(ques_category_token)
                    for char in ques_category_chars:
                        char_counter[char] += 1
                        ques_chars.append(char)
