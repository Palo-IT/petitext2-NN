...
from ques_cat_prepro import prepro
from ques_cat_main import train, test
...
home = os.path.join("/home/ubuntu/spacework/R-NET-new-2")
...
## Change the limit of the text and the question 
# flags.DEFINE_integer("para_limit", 400, "Limit length for paragraph")
# flags.DEFINE_integer("ques_limit", 50, "Limit length for question")

flags.DEFINE_integer("para_limit", 401, "Limit length for paragraph")
flags.DEFINE_integer("ques_limit", 56, "Limit length for question")
...
flags.DEFINE_integer("batch_size", 54, "Batch size")
...
# flags.DEFINE_integer("ques_category_char_limit", 10, "Limit length for question category character")
